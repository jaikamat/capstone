describe('ScrollFactory', function () {
  ...
  beforeEach('inject tools', inject(function (_ScrollFactory_) {
    ...
    var scroll1 = ScrollFactory.createScroll();
  ...
  describe('Scroll', function () {
    ...
    describe('addCondition method', function () {
      it('should add conditions to the scroll', function () {
        scroll1.addCondition(0);
        scroll1.addCondition(1);
        scroll1.addCondition(2);
        scroll1.addCondition(3);
        var counter = 0;
        Object.keys(scroll1.items).forEach(function (key) {
          counter++;
        });
    ...
    describe('setRoute method', function () {
      it('should connect a scroll', function () {
        ...
        scroll10.addCondition(4);
        scroll10.setRoute('start', 'next', 0);
        scroll10.pointer = scroll10.items[pointer.next];
        ...
        scroll10.pointer = scroll10.items[pointer.next];
        scroll10.setRoute(4, 'truePath', 'end');
        scroll10.setRoute(4, 'falsePath', 0);
        scroll10.pointer = scroll10.items[pointer.truePath];
